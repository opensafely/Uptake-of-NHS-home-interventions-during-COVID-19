...
#     homecare_type: str, df: pd.DataFrame
# ):
...
#             dirs["output_dir"]+homecare_type+"_table_code_counts_" + i + code + ".csv"
#         )
#         i = i + 1
...
#     df = (
#         df.reset_index()
#         .groupby(df.columns.tolist())["patient_id"]
#         .nunique()
#     )
...
# def code_analysis(homecare_type: str, codes: dict):
#     """Function to summarise how many times patients received each code over the
...
#     population_df = create_population_df(homecare_type, dirs["output_dir"])
